...
function markTodoCompleted() {
  ...
  const input = prompt("Enter the NUMBER of the todo to complete: ");
...
function deleteTodo() {
  ...
  const input = prompt("Enter the NUMBER of the todo to delete: ");
  const index = Number(input) - 1;
...
function runTodoApp() {
  ...
  while (running) {
    console.log("\nMENU: add | complete | delete | list | exit");
